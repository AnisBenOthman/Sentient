...
const bu1 = { id: 'bu-1', name: 'BU 1', address: 'Algiers', currency: 'DZD', isActive: true, createdAt: new Date(), updatedAt: new Date() };
const bu2 = { id: 'bu-2', name: 'BU 2', address: 'Oran', currency: 'DZD', isActive: true, createdAt: new Date(), updatedAt: new Date() };
