...
function makeLeaveType(requiresApproval = true, buId = 'bu-1') {
  return { id: 'lt-1', businessUnitId: buId, name: 'Annual', defaultDaysPerYear: new Prisma.Decimal(24), accrualFrequency: 'MONTHLY', maxCarryoverDays: new Prisma.Decimal(5), requiresApproval, color: null, createdAt: new Date(), updatedAt: new Date() };
}
